...
export function kmbrerIcon() {
    return (
        <SvgIcon>
            <svg width="563" height="672" viewBox="0 0 563 672" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.5 671V671.5H1H201.5H202.002L202 670.998L201.501 511.344L256.946 490.275L360.572 661.259L360.718 661.5H361H561H561.888L561.428 660.741L361.585 331L561.428 1.25915L561.888 0.5H561H361H360.718L360.572 0.740849L201.5 263.21V201V200.275L200.822 200.533L0.822391 276.533L0.5 276.655V277V671Z" fill="black" stroke="black" />
                <g clip-path="url(#clip0_102_7)">
                    <path d="M101 57.7762C71.6517 57.7762 47.7759 81.6521 47.7759 111C47.7759 140.348 71.6517 164.224 101 164.224C130.348 164.224 154.224 140.348 154.224 111C154.224 81.6521 130.348 57.7762 101 57.7762Z" fill="black" />
                    <path d="M171.71 40.2895C152.823 21.402 127.711 11 101 11C74.2884 11 49.1771 21.402 30.2895 40.2895C11.4016 59.1767 1 84.2892 1 111C1 137.71 11.402 162.823 30.2895 181.71C49.1767 200.598 74.2892 211 101 211C127.711 211 152.824 200.598 171.711 181.71C190.598 162.823 201 137.711 201 111C201 84.2888 190.598 59.1771 171.71 40.2895ZM101 176.106C65.1001 176.106 35.8942 146.899 35.8942 111C35.8942 75.1009 65.1009 45.8946 101 45.8946C136.899 45.8946 166.105 75.1009 166.105 111C166.105 146.899 136.899 176.106 101 176.106Z" fill="black" />
                </g>
                <defs>
                    <clipPath id="clip0_102_7">
                        <rect width="200" height="200" fill="white" transform="translate(1 11)" />
                    </clipPath>
                </defs>
            </svg>
