...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.Component<'custom-types.address', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    phone: Schema.Attribute.Component<'custom-types.phone', false>;
    publishedAt: Schema.Attribute.DateTime;
    redsys: Schema.Attribute.Component<'custom-types.redsys-data', false>;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    complement: Schema.Attribute.Component<'product.complement', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isPaid: Schema.Attribute.Enumeration<['false', 'partial', 'true']> &
      Schema.Attribute.DefaultTo<'false'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    payment: Schema.Attribute.Relation<
      'oneToMany',
    ...
    seat: Schema.Attribute.Relation<'manyToOne', 'api::seat.seat'>;
    sharedWith: Schema.Attribute.Relation<'oneToMany', 'api::seat.seat'>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    numOfSeats: Schema.Attribute.Integer;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    paidBy: Schema.Attribute.Relation<'oneToOne', 'api::seat.seat'>;
    paidFor: Schema.Attribute.Relation<'oneToMany', 'api::seat.seat'>;
    paymentItems: Schema.Attribute.Relation<
      'oneToMany',
      'api::payment-item.payment-item'
    >;
    publishedAt: Schema.Attribute.DateTime;
    transactionComplete: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    type: Schema.Attribute.Enumeration<['cash', 'redsys']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isAvailabile: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
...
export interface ApiRestaurantRestaurant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    horary: Schema.Attribute.Component<'custom-types.opening-hours', true>;
    IAM: Schema.Attribute.UID<
      undefined,
      {
...
export interface ApiTableTable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    canOpenOrder: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    code: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
